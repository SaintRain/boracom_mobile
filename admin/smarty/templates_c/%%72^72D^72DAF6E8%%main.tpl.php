...
<FRAMESET
	COLS="<?php if ($_COOKIE['display_menu'] == 'false'): ?>0<?php else: ?><?php echo @SETTINGS_LEFT_FRAME_WIDTH; ?>
<?php endif; ?>,*"
...
" bordercolor="#22364F" scrolling="auto" noresize style="border: 0" name="basefrm" id="basefrm">
</FRAMESET>
<noframes></noframes>
</html>