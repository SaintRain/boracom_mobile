<?php /* Smarty version 2.6.26, created on 2014-09-14 11:30:28
         compiled from E:/Zend/Apache2/htdocs/honda/modules/Zvonok/performance/ShowZvonokFormTemplates/ContactForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ftext', 'E:/Zend/Apache2/htdocs/honda/modules/Zvonok/performance/ShowZvonokFormTemplates/ContactForm.tpl', 3, false),)), $this); ?>
<br/>
<br/>
<form fastedit:<?php echo $this->_tpl_vars['table_name']; ?>
: id="contact_form" style="margin-top:0px" action="#contact_form" method='post' enctype='multipart/form-data' onreset="return confirm('<?php echo ((is_array($_tmp='Вы действительно хотите очистить форму?')) ? $this->_run_mod_handler('ftext', true, $_tmp) : smarty_modifier_ftext($_tmp)); ?>
')">
  <p>
...
<?php if ($this->_tpl_vars['item']['nnull']): ?> <span style="color:red">*</span><?php endif; ?>&nbsp;&nbsp;</td>
...
" src='/modules/<?php echo $this->_tpl_vars['moduleInfo']['module_name']; ?>
/kcaptcha/index.php' />
        </div>
        <div style="float:left">
          <br/>
...
function  reloadKcaptcha() {	
	var time = Math.random();			
 	document.getElementById(\'kcaptcha_img\').src="/modules/'; ?>
<?php echo $this->_tpl_vars['moduleInfo']['module_name']; ?>
<?php echo '/kcaptcha/index.php?t="+time;    
}
</script> 
'; ?>
