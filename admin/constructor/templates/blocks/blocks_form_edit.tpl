<form action="?act=b_c&do=saveedit&b_id={$id}" method="POST" style="margin:0">
      ...
      <td><table align="center" cellpadding="1" cellspacing="0" bgcolor="#74a9d3" border="0"  style="width:100%">
          <tr>
            <td><table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td>{$MSGTEXT.blocks_form_edit_name_mess}</td>
                </tr>
                <tr>
                  <td><input type="text" name="name" style="width:100%;" value="{$name}"></td>
                </tr>
                <tr>
                  <td>{$MSGTEXT.blocks_form_edit_type_block}<br>
                ...
                <tr>
                  <td>{$MSGTEXT.blocks_form_edit_description}</td>
                </tr>
                <tr>
...
{/foreach}
                ...
                <tr>
                  <td>{$MSGTEXT.blocks_form_edit_name_value}</td>
                </tr>
                <tr>
                  <td><input type="text" name="act_variable" style="width:100%;" value="{$act_variable}"></td>
                </tr>
                <tr>
                  <td>{$MSGTEXT.blocks_form_edit_type_value}</td>
                </tr>
                <tr>
                  <td><table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td><input style="margin:0" name="act_method" {if $act_method=='get'}checked{/if} value="get" type="radio"></td>
                        <td>&nbsp;GET</td>
                      </tr>
                      <tr>
                        <td height="5px"></td>
                ...
                <tr>
                  <td><input class="button" type="submit" value="{$MSGTEXT.blocks_form_edit_save}" style="width:130px"></td>
                </tr>
              </table>
              </td>
          </tr>
