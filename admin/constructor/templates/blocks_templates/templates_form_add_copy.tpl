<p style="margin-bottom:10"><font color="yellow"> {foreach from=$editError item=item}
  {$item}<br>
  {/foreach}
  {$message}</font></p>
<form action="?act=b_temp_c&do=insert&b_id={$b_id}" method="POST" style="margin:0">
            ...
            <td><table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td><table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td>{$MSGTEXT.blocks_templates_form_name} <font color="yellow">*</font><br>
                ...
                <tr>
                  <td>{$MSGTEXT.blocks_templates_form_description} <font color="yellow">*</font><br>
                    <textarea class="editarea_field" style="height:50px" name="description" id="description" >{$description}</textarea></td>
                </tr>
                <tr style="display:none">
                  <td>{$MSGTEXT.blocks_templates_form_content} </font><br>
                    <textarea class="editarea_field" rows="37%" name="content" id="textarea_1" >{$content}</textarea></td>
                </tr>
                <tr>
                  <td><input class="button" type="submit" value="{$MSGTEXT.blocks_templates_form_make}" style="width:120px" ></td>
                </tr>
              </table>
              </td>
          </tr>
