...
{/if}
<form id="data form" action="?act=css&do=saveedit&fname={$smarty.get.fname}" method="POST" onsubmit="return Mysubmit(this)" style="margin:0px">
      ...
      <td><table align="center" cellpadding="1" cellspacing="0" bgcolor="#74a9d3" border="0" width="100%">
          <tr>
            <td><table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td>{$MSGTEXT.css_edit_name_file}<font color="yellow">*</font><br>
                    <input type="text" style="width:100%" name="name" value="{$name}"></td>
                </tr>
                <tr>
                  <td>{$MSGTEXT.css_edit_content}</font><br>
                ...
                <tr>
                  <td>
                     <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                    	    <td>
                        	<input class="button" type="submit" value="{$MSGTEXT.css_edit_save}" style="width:130px">
