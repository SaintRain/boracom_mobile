<?php /* Smarty version 2.6.26, created on 2014-09-14 09:30:12
         compiled from blocks/blocks_form_edit.tpl */ ?>
<form action="?act=b_c&do=saveedit&b_id=<?php echo $this->_tpl_vars['id']; ?>
      ...
      <td><table align="center" cellpadding="1" cellspacing="0" bgcolor="#74a9d3" border="0"  style="width:100%">
          <tr>
            <td><table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td><?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_name_mess']; ?>
</td>
                </tr>
                <tr>
...
"></td>
                ...
                <tr>
                  <td><?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_type_block']; ?>
<br>
...
&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr>
                  <td><?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_description']; ?>
</td>
                </tr>
                <tr>
...
<?php endforeach; endif; unset($_from); ?>
                ...
                <tr>
                  <td><?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_name_value']; ?>
</td>
                </tr>
                <tr>
                  <td><input type="text" name="act_variable" style="width:100%;" value="<?php echo $this->_tpl_vars['act_variable']; ?>
"></td>
                </tr>
                <tr>
                  <td><?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_type_value']; ?>
</td>
                </tr>
                <tr>
                  <td><table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td><input style="margin:0" name="act_method" <?php if ($this->_tpl_vars['act_method'] == 'get'): ?>checked<?php endif; ?> value="get" type="radio"></td>
                        <td>&nbsp;GET</td>
                      </tr>
                      <tr>
                        <td height="5px"></td>
                ...
                <tr>
                  <td><input class="button" type="submit" value="<?php echo $this->_tpl_vars['MSGTEXT']['blocks_form_edit_save']; ?>
