      ...
      <td><table align="center" cellpadding="1" cellspacing="0" bgcolor="#74a9d3" border="0"  style="width:100%">
          <tr>
            <td><table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td> {$MSGTEXT.modules_form_edit_name}<br>
                ...
                <tr>
                  <td> {$MSGTEXT.modules_form_edit_des}<br>
                    <textarea name="description" style="width:100%;" rows="4">{$description}</textarea>
                <tr>
                  <td height="10px"></td>
                </tr>
                <tr>
                  <td><input class="button" type="submit" value="{$MSGTEXT.modules_form_edit}" style="width:130px"></td>
                </tr>
              </table>
              </td>
          </tr>
