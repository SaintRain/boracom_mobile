...
class Sypex_Dumper {
	...
	function ajax($req){
		...
		switch($req['act']){
			...
			case 'exit': 
				setcookie('sxd', '', 0);
				$res = "location.href = '" . mysql_escape_string($this->CFG['exitURL']) . "'"; 
				break;
		}	
		echo $res;
	}
...
if ($_POST['user']=='')		$_POST['user']=MYSQL_USER;
if ($_POST['pass']=='')		$_POST['pass']=MYSQL_PASSWORD;
if ($_POST['host']=='')		$_POST['host']=MYSQL_HOST;
