...
$foreground_color =array(255,255,255); //array(mt_rand(0,100), mt_rand(0,100), mt_rand(0,100));
$background_color =array(146,92 ,191);// array(mt_rand(200,255), mt_rand(200,255), mt_rand(200,255));
