<?php /* Smarty version 2.6.26, created on 2014-09-14 10:31:47
         compiled from modules_forms/modules_form_add.tpl */ ?>
      ...
      <table align="center" cellpadding="1" cellspacing="0" bgcolor="#74a9d3" border="0" style="width:100%">
          <tr>
            ...
            <table width="100%" class="formbackground" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td> <?php echo $this->_tpl_vars['MSGTEXT']['modules_form_add_name']; ?>
<br>
...
<br>
                    <input type="text" name="version" style="width:100%;" value="<?php if ($this->_tpl_vars['version']): ?><?php echo $this->_tpl_vars['version']; ?>
<?php else: ?>1<?php endif; ?>"></td>
                </tr>
                <tr>
                  <td> <?php echo $this->_tpl_vars['MSGTEXT']['modules_form_add_des']; ?>
<br>
                ...
                <tr>
                  <td><input class="button" type="submit" value="<?php echo $this->_tpl_vars['MSGTEXT']['modules_form_add_create_copy']; ?>
