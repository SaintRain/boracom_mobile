...
',
  ...
  array (
    ...
    array (
      ...
      'module_id' => '16',
      'type' => '2',
      'name' => 'ShowFormZadatVopros',
      'description' => 'Форма контактов',
      'act_variable' => 'contactVopros',
      'act_method' => 'post',
      'url_get_vars' => '',
      'general_table_id' => '42',
      'loaded_name' => 'ShowFormZadatVopros',
      'sort_index' => '466',
      'settings' => 
      array (
        0 => 
...
',
          ...
          'sort_index' => '890',
          'block_name' => 'ShowFormZadatVopros',
        ),
        1 => 
        array (
          'id' => '62',
...
File',
  ...
  array (
    'id' => '16',
    'name' => 'ContactsZadatVopros',
    'version' => '1',
    'description' => 'Задать вопрос',
    'loaded' => '1',
    'need_save' => '1',
    'loaded_name' => 'ContactsZadatVopros',
    'sort_index' => '16',
  ),
  'TABLES_DATA' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'select_values' => '',
        'regular' => '0',
        'extensions' => '.xls, .doc, .docx, .rar, .zip, .txt, .trf, .bmp, .jpg, .png, .gif',
        'nnull' => '0',
        'height' => '',
        'width' => '400px',
        'class' => '',
