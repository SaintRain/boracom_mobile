      ...
      <table cellpadding="4" cellspacing="0" border="0" bgcolor="#86bae0" >
          <tr>
            ...
            <table cellpadding="2" cellspacing="0" border="0">
                <tr>
                  <td align="left" style="color:#22364F;font-family:Arial;font-size:12px;"><b>{$MSGTEXT.add_link_form_name}</b></td>
                ...
                <tr>
                  <td colspan="2" align="center"><input style="width:110px" onclick="addUrl()" type="button" value="{$MSGTEXT.add_link_form_add}" class="button">
                    &nbsp;&nbsp;
                    <input style="width:110px" onclick="hideFormBlocks()" type="button" value="{$MSGTEXT.add_link_form_cancel}" class="button"></td>
                </tr>
              </table>
              </td>
          </tr>
