<?php /* Smarty version 2.6.26, created on 2016-02-06 10:47:01
         compiled from pages/pages_form_edit.tpl */ ?>
<?php echo '
...
<form id="data form" action="?act=pages&page_id=<?php echo $this->_tpl_vars['id']; ?>
<?php if ($this->_tpl_vars['page_category']): ?>&pageCategoryId=<?php echo $this->_tpl_vars['page_category']; ?>
<?php endif; ?>&do=saveedit" method="POST" onsubmit="return Mysubmit(this)" style="margin:0">
  ...
  <table class="formborder" border="0" width="100%" cellpadding="1" cellspacing="0">
	...
	<td>     
      <table class="formbackground" width="100%" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td valign="top"><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_description']; ?>
</td>
...
" onkeyup="javascript:checkTotransliteMe(this.value)"></td>
                ...
                <td nowrap><table border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                      ...
                      <td>&nbsp;<?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_translit_mess']; ?>
</td>
                    </tr>
                  </table>
                  </td>
        ...
        <tr>
          <td width="100px"><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_name_page']; ?>
 <font color="yellow">*</font></td>
          <td><input type="text" style="width:100%" name="name" value="<?php echo $this->_tpl_vars['name']; ?>
" id="transVal"></td>
        </tr>
        <tr>
          <td><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_tamplate']; ?>
 <font color="yellow">*</font></td>
          <td><select name="templates_id" style="width:100%">
              <option style="color:gray" value="0" <?php echo $this->_tpl_vars['list']['selected']; ?>
><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_no_tamplate']; ?>
...
" <?php if ($this->_tpl_vars['list']['id'] == $this->_tpl_vars['templates_id']): ?> selected <?php endif; ?>><?php echo $this->_tpl_vars['list']['tpl_name']; ?>
 &rarr; <?php echo $this->_tpl_vars['list']['name']; ?>
        ...
        <tr>
          <td><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_category']; ?>
 </td>
          </td>        
          <td><select name="page_category" id="page_category" style="width:100%">
              <option value="0" style="color:gray"><?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_no_parent']; ?>
...
?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><?php echo $this->_tpl_vars['list']['name']; ?>
        ...
        <tr>
          ...
          <td><table border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td><input value="1" type="checkbox" class="checkbox" <?php if ($this->_tpl_vars['enable'] == true): ?> checked <?php endif; ?> name="enable" id="enable"></td>
                <td>&nbsp;<?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_publish']; ?>
</td>
                <td width="15px"></td>
                <td><input value="1" type="checkbox" <?php if ($this->_tpl_vars['cache'] == true): ?> checked <?php endif; ?> onclick="javascript:set_status_for_checkbox(this)" name="cache" id="cache"></td>
                <td>&nbsp;<?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_cached']; ?>
</td>
                <td width="15px"></td>
                <td><input value="1" type="checkbox"  <?php if (! $this->_tpl_vars['cache']): ?> disabled <?php endif; ?> <?php if ($this->_tpl_vars['disable_cache_if_get'] == true): ?> checked <?php endif; ?> name="disable_cache_if_get" id="disable_cache_if_get"></td>
                <td>&nbsp;<?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_mess_cache']; ?>
</td>
                <td width="15px"></td>
                <td><input value="1" type="checkbox" <?php if ($this->_tpl_vars['selected'] == true): ?> checked <?php endif; ?> name="selected" id="selected"></td>
        ...
        <tr>
          <td></td>
          <td><input class="button" type="submit" value="<?php echo $this->_tpl_vars['MSGTEXT']['pages_edit_save']; ?>
