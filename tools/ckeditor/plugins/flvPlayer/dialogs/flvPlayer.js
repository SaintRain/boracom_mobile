...
(function(){
                ...
                case ATTRTYPE_OBJECT:
                    ...
                    if ( isRemove || isCheckbox && value === attrDef[ 'default' ] )
                        ...
                        if(attrDef.name == 'flashvars')
                        {
                            ...
                            value = 'config={"clip":{"url":"' + escape( value ) + '", "autoBuffering":true,  "autoPlay":false}'+ CKEDITOR.config.flvPlayer.extraFlashVars +'}';
    ...
    CKEDITOR.dialog.add( 'flvPlayer', function( editor )
    {
        ...
        var previewPreloader,
            ...
            '<div id="FlashPreviewLoader" style="display:none"><div class="loading">' 
            +'</div></div>' +
